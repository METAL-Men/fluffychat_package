...
class L10nTa extends L10n {
  ...
  @override
  String get setPermissionsLevelDescription => 'தயவுசெய்து கீழே ஒரு முன் வரையறுக்கப்பட்ட பாத்திரத்தைத் தேர்வுசெய்க அல்லது 0 மற்றும் 100 க்கு இடையில் தனிப்பயன் இசைவு நிலையை உள்ளிடவும்.';
  ...
  @override
  String get commandHint_roomupgrade => 'கொடுக்கப்பட்ட அறை பதிப்பிற்கு இந்த அறையை மேம்படுத்தவும்';
  ...
  @override
  String get noChatsFoundHere => 'இங்கே அரட்டைகள் எதுவும் காணப்படவில்லை. கீழே உள்ள பொத்தானைப் பயன்படுத்தி ஒருவருடன் புதிய அரட்டையைத் தொடங்கவும். ⤵️';
  ...
  @override
  String get otherPartyNotLoggedIn => 'மற்ற கட்சி தற்போது உள்நுழைந்திருக்கவில்லை, எனவே செய்திகளைப் பெற முடியாது!';
  ...
  @override
  String get appWantsToUseForLoginDescription => 'உங்களைப் பற்றிய தகவல்களைப் பகிர பயன்பாடு மற்றும் வலைத்தளத்தை இதன்மூலம் அனுமதிக்கிறீர்கள்.';
  ...
  @override
  String get appIntroduction => 'வெவ்வேறு தூதர்களில் உங்கள் நண்பர்களுடன் அரட்டையடிக்க உங்களை பஞ்சுபோன்றது உங்களை அனுமதிக்கிறது. Https://matrix.org இல் மேலும் அறிக அல்லது *தொடரவும் *தட்டவும்.';
  ...
  @override
  String get userSpecificNotificationSettings => 'பயனர் குறிப்பிட்ட அறிவிப்பு அமைப்புகள்';
  ...
  @override
  String get notificationRuleContainsUserNameDescription => 'ஒரு செய்தியில் அவற்றின் பயனர்பெயர் இருக்கும்போது பயனருக்கு அறிவிக்கிறது.';

  @override
  String get notificationRuleMaster => 'அனைத்து அறிவிப்புகளையும் முடக்குகிறது';

  @override
  String get notificationRuleMasterDescription => 'மற்ற எல்லா விதிகளையும் மீறி அனைத்து அறிவிப்புகளையும் முடக்குகிறது.';

  @override
  String get notificationRuleSuppressNotices => 'தானியங்கு செய்திகளை அடக்கவும்';

  @override
  String get notificationRuleSuppressNoticesDescription => 'போட்ச் போன்ற தானியங்கி வாடிக்கையாளர்களிடமிருந்து அறிவிப்புகளை அடக்குகிறது.';

  @override
  String get notificationRuleInviteForMe => 'எனக்கு அழைக்கவும்';

  @override
  String get notificationRuleInviteForMeDescription => 'ஒரு அறைக்கு அழைக்கப்படும்போது பயனருக்கு அறிவிக்கிறது.';

  @override
  String get notificationRuleMemberEvent => 'உறுப்பினர் நிகழ்வு';

  @override
  String get notificationRuleMemberEventDescription => 'உறுப்பினர் நிகழ்வுகளுக்கான அறிவிப்புகளை அடக்குகிறது.';

  @override
  String get notificationRuleIsUserMention => 'பயனர் குறிப்பு';

  @override
  String get notificationRuleIsUserMentionDescription => 'ஒரு செய்தியில் நேரடியாக குறிப்பிடப்படும்போது பயனருக்கு அறிவிக்கிறது.';

  @override
  String get notificationRuleContainsDisplayName => 'காட்சி பெயரைக் கொண்டுள்ளது';

  @override
  String get notificationRuleContainsDisplayNameDescription => 'ஒரு செய்தியில் அவற்றின் காட்சி பெயர் இருக்கும்போது பயனருக்கு அறிவிக்கிறது.';

  @override
  String get notificationRuleIsRoomMention => 'அறை குறிப்பு';

  @override
  String get notificationRuleIsRoomMentionDescription => 'ஒரு அறை குறிப்பு இருக்கும்போது பயனருக்கு அறிவிக்கிறது.';

  @override
  String get notificationRuleRoomnotif => 'அறை அறிவிப்பு';

  @override
  String get notificationRuleRoomnotifDescription => 'ஒரு செய்தியில் \'@ROOM\' இருக்கும்போது பயனருக்கு அறிவிக்கிறது.';

  @override
  String get notificationRuleTombstone => 'கல்லறை';

  @override
  String get notificationRuleTombstoneDescription => 'அறை செயலிழக்கச் செய்திகளைப் பற்றி பயனருக்கு அறிவிக்கிறது.';

  @override
  String get notificationRuleReaction => 'எதிர்வினை';

  @override
  String get notificationRuleReactionDescription => 'எதிர்வினைகளுக்கான அறிவிப்புகளை அடக்குகிறது.';

  @override
  String get notificationRuleRoomServerAcl => 'அறை சேவையகம் ACL';

  @override
  String get notificationRuleRoomServerAclDescription => 'அறை சேவையக அணுகல் கட்டுப்பாட்டு பட்டியல்களுக்கான (ACL) அறிவிப்புகளை அடக்குகிறது.';

  @override
  String get notificationRuleSuppressEdits => 'திருத்தங்களை அடக்கவும்';

  @override
  String get notificationRuleSuppressEditsDescription => 'திருத்தப்பட்ட செய்திகளுக்கான அறிவிப்புகளை அடக்குகிறது.';

  @override
  String get notificationRuleCall => 'அழை';

  @override
  String get notificationRuleCallDescription => 'அழைப்புகள் பற்றி பயனருக்கு அறிவிக்கிறது.';

  @override
  String get notificationRuleEncryptedRoomOneToOne => 'மறைகுறியாக்கப்பட்ட அறை ஒன்றுக்கு ஒன்று';

  @override
  String get notificationRuleEncryptedRoomOneToOneDescription => 'மறைகுறியாக்கப்பட்ட ஒன்றுக்கு ஒன்று அறைகளில் செய்திகளைப் பற்றி பயனருக்கு அறிவிக்கிறது.';

  @override
  String get notificationRuleRoomOneToOne => 'அறை ஒன்று';

  @override
  String get notificationRuleRoomOneToOneDescription => 'ஒருவருக்கு ஒன்று அறைகளில் செய்திகளைப் பற்றி பயனருக்கு அறிவிக்கிறது.';

  @override
  String get notificationRuleMessage => 'செய்தி';

  @override
  String get notificationRuleMessageDescription => 'பொதுவான செய்திகளைப் பற்றி பயனருக்கு அறிவிக்கிறது.';

  @override
  String get notificationRuleEncrypted => 'குறியாக்கப்பட்டது';

  @override
  String get notificationRuleEncryptedDescription => 'மறைகுறியாக்கப்பட்ட அறைகளில் செய்திகளைப் பற்றி பயனருக்கு அறிவிக்கிறது.';

  @override
  String get notificationRuleJitsi => 'சியோட்ச்';

  @override
  String get notificationRuleJitsiDescription => 'சிட்சி விட்செட் நிகழ்வுகளைப் பற்றி பயனருக்கு அறிவிக்கிறது.';

  @override
  String get notificationRuleServerAcl => 'சேவையக ACL நிகழ்வுகளை அடக்கவும்';

  @override
  String get notificationRuleServerAclDescription => 'சேவையக ACL நிகழ்வுகளுக்கான அறிவிப்புகளை அடக்குகிறது.';
  ...
  @override
  String get deletePushRuleCanNotBeUndone => 'இந்த அறிவிப்பு அமைப்பை நீங்கள் நீக்கினால், இதை செயல்தவிர்க்க முடியாது.';
  ...
  @override
  String get shareKeysWithDescription => 'மறைகுறியாக்கப்பட்ட அரட்டைகளில் உங்கள் செய்திகளுடன் படிக்க எந்த சாதனங்களை நம்ப வேண்டும்?';

  @override
  String get allDevices => 'அனைத்து சாதனங்களும்';

  @override
  String get crossVerifiedDevicesIfEnabled => 'இயக்கப்பட்டால் சரிபார்க்கப்பட்ட சாதனங்களை குறுக்கு';
  ...
  @override
  String get pleaseWaitUntilInvited => 'அறையில் இருந்து யாராவது உங்களை அழைக்கும் வரை தயவுசெய்து இப்போது காத்திருங்கள்.';

  @override
  String get commandHint_logout => 'உங்கள் தற்போதைய சாதனத்தை பதிவு செய்க';

  @override
  String get commandHint_logoutall => 'அனைத்து செயலில் உள்ள சாதனங்களையும் அனுப்புகிறது';
