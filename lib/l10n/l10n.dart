...
class _L10nDelegate extends LocalizationsDelegate<L10n> {
  ...
  @override
  bool isSupported(Locale locale) => <String>['ar', 'be', 'bn', 'bo', 'ca', 'cs', 'da', 'de', 'el', 'en', 'eo', 'es', 'et', 'eu', 'fa', 'fi', 'fil', 'fr', 'ga', 'gl', 'he', 'hi', 'hr', 'hu', 'ia', 'id', 'ie', 'it', 'ja', 'ka', 'ko', 'lt', 'lv', 'nb', 'nl', 'pl', 'pt', 'ro', 'ru', 'sk', 'sl', 'sr', 'sv', 'ta', 'te', 'th', 'tr', 'uk', 'vi', 'yue', 'zh'].contains(locale.languageCode);
...
case 'PT': return l10n_pt.loadLibrary().then((dynamic _) => l10n_pt.L10nPtPt());
  ...
  switch (locale.languageCode) {
    ...
    case 'da': return l10n_da.loadLibrary().then((dynamic _) => l10n_da.L10nDa());
    ...
    case 'yue': return l10n_yue.loadLibrary().then((dynamic _) => l10n_yue.L10nYue());
