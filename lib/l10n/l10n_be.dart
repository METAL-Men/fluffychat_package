...
class L10nBe extends L10n {
  ...
  @override
  String get setCustomPermissionLevel => 'Задайце карыстальніцкі ўзровень дазволу';

  @override
  String get setPermissionsLevelDescription => 'Калі ласка, выберыце ролю ніжэй альбо ўвядзіце карыстальніцкі ўзровень дазволу паміж 0 і 100.';
  ...
  @override
  String get confirmMatrixId => 'Калі ласка, спраўдзіце свой Matrix ID перад выдаленнем свайго ўліковага запісу.';
  ...
  @override
  String get commandHint_roomupgrade => 'Палепшыце гэты пакой да версіі дадзенага пакою';
  ...
  @override
  String get appLockDescription => 'Блакіруе праграму, пакуль вы не ўвядзеце пін-код';
  ...
  @override
  String get askSSSSSign => 'Каб увайсці як іншы чалавек, калі ласка, увядзіце ключавую фразу ці ключ аднаўлення.';
  ...
  @override
  String get autoplayImages => 'Аўтаматычна прайграваць аніміраваныя стыкеры і эмодзі';
  ...
  @override
  String get noChatsFoundHere => 'Здаецца, тут пуств. Пачніце новы чат з кімсьці праз кнопку ніжэй. ⤵️';
