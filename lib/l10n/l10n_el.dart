...
class L10nEl extends L10n {
  ...
  @override
  String get confirmMatrixId => 'Παρακαλούμε επιβεβαιώστε το Matrix ID σας για να διαγράψετε τον λογαριασμό σας.';
  ...
  @override
  String get areGuestsAllowedToJoin => 'Επιτρέπεται στους φιλοξενούμενους χρήστες να συμμετάσχουν';
  ...
  @override
  String get askSSSSSign => 'Για να μπορέσετε να υπογράψετε το άλλο άτομο, πληκτρολογήστε τη συνθηματική φράση ασφαλούς αποθήκευσης ή το κλειδί ανάκτησης.';
  ...
  @override
  String get autoplayImages => 'Αυτόματη αναπαραγωγή κινούμενων αυτοκόλλητων και emotes';
