...
class L10nFa extends L10n {
  ...
  @override
  String get setPermissionsLevelDescription => 'لطفاً نقش از پیش تعریف‌شده‌ای را انتخاب کنید یا سطح دسترسی سفارشی بین ۰ تا ۱۰۰ وارد کنید.';
  ...
  @override
  String get confirmMatrixId => 'برای پاک کردن حساب، لطفاً هویت ماتریکس خود را بپذیرید.';
  ...
  @override
  String get appLockDescription => 'قفل کردن برنامه با رمز کوتاه هنگام عدم استفاده';
  ...
  @override
  String get askSSSSSign => 'لطفاً عبارت عبور یا کلید بازیابی حافظه امن را وارد کنید تا شخص دیگری را امضا کنید.';
  ...
  @override
  String get noChatsFoundHere => 'اینجا هنوز گپی پیدا نشد. با استفاده از دکمه زیر گپ جدیدی با کسی شروع کنید. ⤵️';
  ...
  @override
  String get chatBackupDescription => 'پیام‌های قدیمی شما با یک کلید بازیابی امن می‌شوند. لطفاً مطمئن شوید آن را گم نمی‌کنید.';
  ...
  @override
  String get commandHint_markasdm => 'علامت‌گذاری به‌عنوان اتاق پیام مستقیم با شناسه ماتریکس';
  ...
  @override
  String get commandHint_myroomavatar => 'تنظیم نماد نمایه برای این اتاق (با mxc-uri)';
  ...
  @override
  String get deactivateAccountWarning => 'این کار حساب شما را غیرفعال می‌کند. این کنش برگشت‌ناپذیر است! آیا مطمئن هستید؟';
  ...
  @override
  String get emoteKeyboardNoRecents => 'شکلک‌هایی که به تازگی استفاده‌شده اینجا نمایش داده میشوند...';
  ...
  @override
  String get accessAndVisibilityDescription => 'چه کسی اجازه پیوستن به این گپ را دارد و گپ چگونه قابل کشف است.';
  ...
  @override
  String get customEmojisAndStickersBody => 'افزودن یا هم‌رسانی شکلک‌ها یا برچسب‌های سفارشی که در هر گپ قابل استفاده‌اند.';
  ...
  @override
  String get enableEncryptionWarning => 'نمی‌توانید رمزنگاری را غیرفعال کنید. آیا مطمئن هستید؟';
  ...
  @override
  String get hideRedactedMessagesBody => 'اگر کسی پیامی را ویرایش کند، دیگر نمیتوان آن پیام را در گپ دید.';

  @override
  String get hideInvalidOrUnknownMessageFormats => 'پنهان کردن قالب‌های پیام نامعتبر یا ناشناخته';
  ...
  @override
  String get blockListDescription => 'میتوانید کاربرانی که مزاحم شما هستند را مسدود کنید. از کاربران موجود در فهرست مسدود شخصی، پیام یا دعوت به اتاق دریافت نخواهید کرد.';
  ...
  @override
  String get incorrectPassphraseOrKey => 'عبارت عبور یا کلید بازیابی نادرست است';
  ...
  @override
  String get redactMessageDescription => 'پیام برای همه شرکت‌کنندگان در این گفتگو ویرایش خواهد شد. این کار برگشت‌ناپذیر است.';
  ...
  @override
  String get dehydrateWarning => 'این کنش برگشت‌ناپذیر است. مطمئن شوید پرونده پشتیبان را به‌صورت امن ذخیره می‌کنید.';

  @override
  String get dehydrateTor => 'کاربران تور: صدور نشست';

  @override
  String get dehydrateTorLong => 'برای کاربران تور، پیشنهاد می‌شود پیش از بستن پنجره، نشست را صادر کنند.';

  @override
  String get hydrateTor => 'کاربران تور: وارد کردن نشست صادر شده';

  @override
  String get hydrateTorLong => 'آیا آخرین بار نشست خود را با تور صادر کردید؟ آن را وارد کنید و گپ را ادامه دهید.';
  ...
  @override
  String get locationDisabledNotice => 'مکان‌یاب غیرفعال است. لطفاً آن را فعال کنید تا بتوانید مکان خود را هم‌رسانی کنید.';

  @override
  String get locationPermissionDeniedNotice => 'دسترسی به مکان رد شد. برای هم‌رسانی مکان، لطفاً دسترسی بدهید.';
  ...
  @override
  String get needPantalaimonWarning => 'لطفاً توجه کنید که برای رمزنگاری سرتاسر به Pantalaimon نیاز دارید.';
  ...
  @override
  String get noEncryptionForPublicRooms => 'رمزنگاری را تنها زمانی می‌توانید فعال کنید که اتاق عمومی نباشد.';

  @override
  String get noGoogleServicesWarning => 'به نظر می‌رسد دستگاه شما سرویس‌های گوگل ندارد. این انتخاب خوبی برای حریم خصوصی است! برای دریافت آگاه‌سازها در فلافی‌چت، پیشنهاد می‌کنیم از https://ntfy.sh استفاده کنید. با ntfy یا یک فراهم‌کننده UnifiedPush می‌توانید آگاه‌سازهای امن دریافت کنید. می‌توانید ntfy را از Play Store یا F-Droid بارگیری کنید.';
  ...
  @override
  String get noPasswordRecoveryDescription => 'هنوز روشی برای بازیابی گذرواژه خود اضافه نکرده‌اید.';
  ...
  @override
  String get notificationsEnabledForThisAccount => 'آگاه‌سازها برای این حساب فعال شدند';
  ...
  @override
  String get enableMultiAccounts => '(آزمایشی) فعال کردن چند حساب در این دستگاه';
  ...
  @override
  String get serverRequiresEmail => 'برای ثبت‌نام، این سرور باید نشانی رایانامه شما را تأیید کند.';
  ...
  @override
  String get hideMemberChangesInPublicChats => 'پنهان کردن تغییرات اعضا در گپ‌های عمومی';

  @override
  String get hideMemberChangesInPublicChatsBody => 'برای بهبود خوانایی، اینکه کسی به گپ عمومی پیوست یا آن را ترک کرد در خط زمانی گپ نمایش داده نشود.';
  ...
  @override
  String get pleaseClickOnLink => 'لطفاً روی پیوند در رایانامه کلیک کنید و ادامه دهید.';

  @override
  String get pleaseEnter4Digits => 'لطفاً ۴ رقم وارد کنید یا خالی بگذارید تا قفل برنامه غیرفعال شود.';
  ...
  @override
  String get pleaseFollowInstructionsOnWeb => 'لطفاً دستورالعمل‌های وبگاه را دنبال کنید و روی بعدی بزنید.';
  ...
  @override
  String get tooManyRequestsWarning => 'درخواست‌های بیش از حد. لطفاً بعداً دوباره تلاش کنید!';
  ...
  @override
  String get waitingPartnerAcceptRequest => 'در انتظار پذیرش درخواست توسط دیگری…';
  ...
  @override
  String get addToSpaceDescription => 'فضایی را برای افزودن این گپ انتخاب کنید.';
  ...
  @override
  String get saveKeyManuallyDescription => 'این کلید را با استفاده از هم‌رسانی یا بریده‌دان به‌طور دستی ذخیره کنید.';
  ...
  @override
  String get foregroundServiceRunning => 'این آگاه‌ساز زمانی ظاهر می‌شود که خدمت پیش‌زمینه فعال است.';

  @override
  String get screenSharingTitle => 'هم‌رسانی صفحه‌نمایش';

  @override
  String get screenSharingDetail => 'شما در حال هم‌رسانی صفحه‌نمایش خود در فلافی‌چت هستید';
  ...
  @override
  String get newSpaceDescription => 'فضاها امکان یکپارچه‌سازی گپ‌ها و ساخت جوامع خصوصی یا عمومی را فراهم می‌کنند.';

  @override
  String get encryptThisChat => 'رمزنگاری این گپ';

  @override
  String get disableEncryptionWarning => 'به دلایل امنیتی نمی‌توانید رمزنگاری را در گپی که فعال شده غیرفعال کنید.';
  ...
  @override
  String get noBackupWarning => 'هشدار! بدون فعال کردن پشتیبان گپ، دسترسی به پیام‌های رمزنگاری‌شده خود را از دست خواهید داد. پیشنهاد می‌شود پیش از خروج، پشتیبان گپ را فعال کنید.';
  ...
  @override
  String get profileNotFound => 'کاربر در سرور پیدا نشد. شاید مشکل اتصال وجود دارد یا کاربر وجود ندارد.';
  ...
  @override
  String get archiveRoomDescription => 'گپ به بایگانی خواهد رفت. کاربران دیگر میتوانند ببینند که شما گپ را ترک کرده‌اید.';

  @override
  String get roomUpgradeDescription => 'گپ با نگارش جدید اتاق بازسازی خواهد شد. به همه شرکت‌کنندگان آگاهی‌رسانی میشود که باید به گپ جدید بروند. داده‌های بیشتر درباره نگارش‌های اتاق در https://spec.matrix.org/latest/rooms/';

  @override
  String get removeDevicesDescription => 'از این دستگاه خارج خواهید شد و دیگر نمیتوانید پیام دریافت کنید.';

  @override
  String get banUserDescription => 'کاربر از گپ محروم خواهد شد و تا زمانی که محرومیت برداشته نشود، نمیتواند دوباره وارد گپ شود.';

  @override
  String get unbanUserDescription => 'کاربر در صورت تلاش دوباره میتواند وارد گپ شود.';

  @override
  String get kickUserDescription => 'کاربر از گپ بیرون میشود اما محروم نمیشود. در گپ‌های عمومی، کاربر میتواند هر زمان دوباره بپیوندد.';

  @override
  String get makeAdminDescription => 'پس از مدیر کردن این کاربر، ممکن است نتوانید این کار را لغو کنید، زیرا آن‌ها همان دسترسی‌های شما را خواهند داشت.';

  @override
  String get pushNotificationsNotAvailable => 'آگاه‌سازهای فشاری در دسترس نیستند';
  ...
  @override
  String get wrongRecoveryKey => 'متأسفیم... به نظر میرسد این کلید بازیابی درست نباشد.';
  ...
  @override
  String get databaseMigrationBody => 'لطفاً صبر کنید. این ممکن است لحظه‌ای طول بکشد.';
  ...
  @override
  String get pleaseEnterYourCurrentPassword => 'لطفاً گذرواژه کنونی خود را وارد کنید';
  ...
  @override
  String get sendTypingNotificationsDescription => 'دیگر شرکت‌کنندگان در گپ میتوانند ببینند که شما در حال تایپ پیام جدید هستید.';

  @override
  String get sendReadReceiptsDescription => 'دیگر شرکت‌کنندگان در گپ میتوانند ببینند که شما پیام را خوانده‌اید.';

  @override
  String get formattedMessages => 'پیام‌های قالب‌بندی‌شده';

  @override
  String get formattedMessagesDescription => 'نمایش محتوای پیام غنی مانند متن پررنگ با استفاده از مارک‌داون.';

  @override
  String get verifyOtherUser => '🔐 بازبینی کاربر دیگر';

  @override
  String get verifyOtherUserDescription => 'اگر کاربر دیگری را بازبینی کنید، میتوانید مطمئن شوید که واقعاً با چه کسی در حال نوشتن هستید. 💪\n\nهنگام شروع بازبینی، شما و کاربر دیگر پنجره‌ای در برنامه خواهید دید. در آنجا مجموعه‌ای از شکلک‌ها یا اعداد را مشاهده میکنید که باید با یکدیگر مقایسه کنید.\n\nبهترین راه برای این کار دیدار حضوری یا شروع تماس تصویری است. 👭';

  @override
  String get verifyOtherDevice => '🔐 بازبینی دستگاه دیگر';

  @override
  String get verifyOtherDeviceDescription => 'هنگام بازبینی دستگاه دیگر، آن دستگاه‌ها میتوانند کلیدها را تبادل کنند و امنیت کلی شما را افزایش دهند. 💪 هنگام شروع بازبینی، پنجره‌ای در برنامه روی هر دو دستگاه ظاهر میشود. در آنجا مجموعه‌ای از شکلک‌ها یا اعداد را مشاهده میکنید که باید با یکدیگر مقایسه کنید. بهتر است پیش از شروع بازبینی، هر دو دستگاه در دسترس باشند. 🤳';
  ...
  @override
  String get noDatabaseEncryption => 'رمزنگاری پایگاه داده در این سکو پشتیبانی نمیشود';
  ...
  @override
  String get chatPermissionsDescription => 'مشخص کنید کدام سطح دسترسی برای اقدامات خاصی در این گپ لازم است. سطح‌های دسترسی ۰، ۵۰ و ۱۰۰ معمولاً نشان‌دهنده کاربران، ناظران و مدیران هستند، اما هر درجه‌بندی ممکن است.';
  ...
  @override
  String get homeserverDescription => 'همه داده‌های شما روی سرور خانگی نگه‌داری میشوند، مانند یک فراهم‌کننده رایانامه. میتوانید سرور خانگی مورد نظر خود را انتخاب کنید، در حالی که همچنان میتوانید با هر کسی گفتگو کنید. اطلاعات بیشتر در https://matrix.org.';

  @override
  String get doesNotSeemToBeAValidHomeserver => 'به نظر نمیرسد سرور خانگی سازگاری داشته باشد. نشانی اشتباه است؟';
  ...
  @override
  String get oneOfYourDevicesIsNotVerified => 'یکی از دستگاه‌های شما بازبینی نشده است';

  @override
  String get noticeChatBackupDeviceVerification => 'توجه: وقتی همه دستگاه‌های خود را به پشتیبان گپ متصل کنید، به‌صورت خودکار بازبینی میشوند.';

  @override
  String get continueText => 'ادامه';

  @override
  String get welcomeText => 'درود درود 👋 این فلافی‌چت است. میتوانید به هر سرور خانگی سازگار با https://matrix.org وارد شوید و با هر کسی گپ بزنید. این یک شبکه پیام‌رسانی غیرمتمرکز بزرگ است!';
  ...
  @override
  String get noContactInformationProvided => 'سرور هیچ اطلاعات تماس معتبری نمیدهد';
  ...
  @override
  String get unableToJoinChat => 'ناتوانی در پیوستن به گپ. شاید طرف مقابل گفتگو را بسته است.';

  @override
  String get previous => 'پیشین';

  @override
  String get otherPartyNotLoggedIn => 'طرف مقابل اکنون وارد نشده است و بنابراین نمیتواند پیام دریافت کند!';
  ...
  @override
  String get appWantsToUseForLoginDescription => 'شما بدین‌وسیله به برنامه و وبگاه اجازه میدهید اطلاعات شما را هم‌رسانی کنند.';
  ...
  @override
  String get appIntroduction => 'فلافی‌چت به شما امکان گپ با دوستانتان در پیام‌رسان‌های مختلف را میدهد. اطلاعات بیشتر در https://matrix.org یا فقط روی *ادامه* بزنید.';
  ...
  @override
  String get notificationRuleContainsUserNameDescription => 'وقتی پیامی حاوی نام کاربری باشد، کاربر را آگاه میکند.';

  @override
  String get notificationRuleMaster => 'بی‌صدا کردن همه آگاه‌سازها';

  @override
  String get notificationRuleMasterDescription => 'از قوانین دیگر چشم‌پوشی میکند و همه آگاه‌سازها را غیرفعال میکند.';

  @override
  String get notificationRuleSuppressNotices => 'سرکوب پیام‌های خودکار';

  @override
  String get notificationRuleSuppressNoticesDescription => 'آگاه‌سازهای کارخواه‌های خودکار مانند ربات‌ها را سرکوب میکند.';

  @override
  String get notificationRuleInviteForMe => 'دعوت برای من';

  @override
  String get notificationRuleInviteForMeDescription => 'وقتی کاربر به اتاقی دعوت میشود، او را آگاه میکند.';

  @override
  String get notificationRuleMemberEvent => 'رویداد عضویت';

  @override
  String get notificationRuleMemberEventDescription => 'آگاه‌سازهای رویدادهای عضویت را سرکوب میکند.';

  @override
  String get notificationRuleIsUserMention => 'نام‌بردن از کاربر';

  @override
  String get notificationRuleIsUserMentionDescription => 'وقتی در پیامی مستقیماً از کاربر نام برده میشود، او را آگاه میکند.';

  @override
  String get notificationRuleContainsDisplayName => 'دارای نام نمایشی';

  @override
  String get notificationRuleContainsDisplayNameDescription => 'وقتی پیامی حاوی نام نمایشی کاربر باشد، کاربر را آگاه میکند.';

  @override
  String get notificationRuleIsRoomMention => 'نام‌بردن از اتاق';

  @override
  String get notificationRuleIsRoomMentionDescription => 'وقتی نام اتاق ذکر میشود، کاربر را آگاه میکند.';

  @override
  String get notificationRuleRoomnotif => 'آگاه‌ساز اتاق';

  @override
  String get notificationRuleRoomnotifDescription => 'وقتی پیامی حاوی \'@room\' باشد، کاربر را آگاه میکند.';

  @override
  String get notificationRuleTombstone => 'سنگ قبر';

  @override
  String get notificationRuleTombstoneDescription => 'کاربر را از پیام‌های غیرفعال‌سازی اتاق آگاه میکند.';

  @override
  String get notificationRuleReaction => 'واکنش';

  @override
  String get notificationRuleReactionDescription => 'آگاه‌سازهای واکنش‌ها را سرکوب میکند.';

  @override
  String get notificationRuleRoomServerAcl => 'ACL سرور اتاق';

  @override
  String get notificationRuleRoomServerAclDescription => 'آگاه‌سازهای فهرست‌های کنترل دسترسی سرور اتاق (ACL) را سرکوب میکند.';

  @override
  String get notificationRuleSuppressEdits => 'سرکوب ویرایش‌ها';

  @override
  String get notificationRuleSuppressEditsDescription => 'آگاه‌سازهای پیام‌های ویرایش‌شده را سرکوب میکند.';

  @override
  String get notificationRuleCall => 'تماس';

  @override
  String get notificationRuleCallDescription => 'درباره تماس‌ها کاربر را آگاه میکند.';

  @override
  String get notificationRuleEncryptedRoomOneToOne => 'اتاق رمزنگاری‌شده یک‌به‌یک';

  @override
  String get notificationRuleEncryptedRoomOneToOneDescription => 'کاربر را از پیام‌ها در اتاق‌های رمزنگاری‌شده یک‌به‌یک آگاه میکند.';

  @override
  String get notificationRuleRoomOneToOne => 'اتاق یک‌به‌یک';

  @override
  String get notificationRuleRoomOneToOneDescription => 'کاربر را از پیام‌ها در اتاق‌های یک‌به‌یک آگاه میکند.';

  @override
  String get notificationRuleMessage => 'پیام';

  @override
  String get notificationRuleMessageDescription => 'کاربر را از پیام‌های عمومی آگاه میکند.';

  @override
  String get notificationRuleEncrypted => 'رمزنگاری‌شده';

  @override
  String get notificationRuleEncryptedDescription => 'کاربر را از پیام‌ها در اتاق‌های رمزنگاری‌شده آگاه میکند.';

  @override
  String get notificationRuleJitsi => 'جیتسی';

  @override
  String get notificationRuleJitsiDescription => 'کاربر را از رویدادهای ابزارک جیتسی آگاه میکند.';

  @override
  String get notificationRuleServerAcl => 'سرکوب رویدادهای ACL سرور';

  @override
  String get notificationRuleServerAclDescription => 'آگاه‌سازهای رویدادهای ACL سرور را سرکوب میکند.';
  ...
  @override
  String get deletePushRuleCanNotBeUndone => 'اگر این تنظیم آگاه‌ساز را پاک کنید، این کار برگشت‌ناپذیر است.';
  ...
  @override
  String get shareKeysWithDescription => 'کدام دستگاه‌ها باید مورد اعتماد باشند تا بتوانند پیام‌های شما را در گپ‌های رمزنگاری‌شده بخوانند؟';

  @override
  String get allDevices => 'همه دستگاه‌ها';

  @override
  String get crossVerifiedDevicesIfEnabled => 'دستگاه‌های بازبینی‌شده متقابل اگر فعال باشد';
  ...
  @override
  String get pleaseWaitUntilInvited => 'لطفاً اکنون صبر کنید تا کسی از اتاق شما را دعوت کند.';
