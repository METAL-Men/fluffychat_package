...
class L10nRu extends L10n {
  ...
  @override
  String get setCustomPermissionLevel => 'Установить уровень пользовательских разрешений';
  ...
  @override
  String get otherPartyNotLoggedIn => 'Другая сторона в настоящее время не вошла в систему и поэтому не может получать сообщения!';
  ...
  @override
  String get appIntroduction => 'FluffyChat позволяет вам общаться с друзьями с разными мессенджерами. Узнайте больше на https://matrix.org или просто нажмите *Продолжить*.';
  ...
  @override
  String get notificationRuleSuppressNoticesDescription => 'Отключить уведомления от автоматизированных клиентов, таких как боты.';
  ...
  @override
  String get notificationRuleMemberEventDescription => 'Отключить уведомления о событиях о членстве.';
  ...
  @override
  String get notificationRuleSuppressEditsDescription => 'Отключить уведомления о отредактированных сообщениях.';

  @override
  String get notificationRuleCall => 'Звонок';

  @override
  String get notificationRuleCallDescription => 'Уведомляет пользователя про звонки.';

  @override
  String get notificationRuleEncryptedRoomOneToOne => 'Шифрованная комната «Один на один»';

  @override
  String get notificationRuleEncryptedRoomOneToOneDescription => 'Уведомляет пользователя про сообщение в зашифрованных комнатах «Один на один».';
