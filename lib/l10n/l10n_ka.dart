...
class L10nKa extends L10n {
  ...
  @override
  String get confirmMatrixId => 'გთხოვთ, დაადასტუროთ თქვენი Matrix ID ანგარიშის წაშლისათვის.';
  ...
  @override
  String get appLockDescription => 'პინკოდის გამოყენების გარეშე აპლიკაციის ბლოკირება';

  @override
  String get archive => 'არქივი';

  @override
  String get areGuestsAllowedToJoin => 'შეუძლიათ თუ არა სტუმარ მომხმარებლებს გაწევრიანება';

  @override
  String get areYouSure => 'დარწმუნებული ხართ?';

  @override
  String get areYouSureYouWantToLogout => 'დარწმუნებული ხართ, რომ გამოსვლა გსურთ?';

  @override
  String get askSSSSSign => 'სხვა მომხმარებლის დადასტურებლად, გთხოვთ, ჩაწეროთ თქვენი ან საიდუმლო ფრაზა, ან აღდგენის გასაღები.';
  ...
  @override
  String get autoplayImages => 'ანიმირებული სტიკერებისა და ემოჯების ავტომატური ჩართვა';
  ...
  @override
  String get yourChatBackupHasBeenSetUp => 'თქვენი ჩატის სარეზერვო საშუალება კონფიგურირებული იქნა.';

  @override
  String get chatBackup => 'ჩატის სარეზერვო საშუალება';

  @override
  String get chatBackupDescription => 'თქვენი ძველი შეტყობინებები დაცულია აღდგების გასაღებით. არ დაკარგოთ ის.';
  ...
  @override
  String get commandHint_create => 'ცარიელი ჯგუფური ჩატის შექმნა\nგამოიყენეთ --no-encryption გაშიფვრის გასათიშად';

  @override
  String get commandHint_discardsession => 'სესიის გაუქმება';

  @override
  String get commandHint_dm => 'პირდაპირი ჩატის დაწყება\nგამოიყენეთ --no-encryption გაშიფვრის გასათიშად';
  ...
  @override
  String get commandHint_myroomavatar => 'თქვენი ფოტოს დაყენება ამ ოთახისათვის(mxc-uri-ს დახმარებით)';

  @override
  String get commandHint_myroomnick => 'ამ ოთახისათვის ნაჩვენები სახელის დაყენება';

  @override
  String get commandHint_op => 'მოცემული მომხმარებლისათვის უფლებების დონის დაყენება (ჩვეულებრივ: 50)';
  ...
  @override
  String get contentHasBeenReported => 'ეს კონტენტი გაგზავნილ იქნა სერვერის ადმინისტრატორებთან';
  ...
  @override
  String get deactivateAccountWarning => 'ეს გააუქმებს თქვენს ანგარიშს. ამის გაუქმება შეუძლებელია. დარწმუნებული ხართ?';
